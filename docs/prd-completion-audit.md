...
| T1.5 | MVP workflow smoke and fixture alignment | `examples/dynasty-embers`, `crates/plotforge-cli/tests/cli_smoke.rs::cli_runs_full_demo_flow_in_tempdir`, `scripts/qa/full_local.sh` | Covered by tempdir CLI flow and fixture checks. |
...
|---|---|---|
| Product scope and MVP core | CLI-first Rust engine, desktop creator adapter, folder project source of truth | `Cargo.toml` workspace members, `plotforge-cli`, `plotforge-storage`, `apps/creator-desktop`, `examples/dynasty-embers`, README scope section |
...
| Demo fixture | Dynasty Embers aligned with schema and smoke flows | `examples/dynasty-embers`, CLI check/play/export smoke, README commands |
