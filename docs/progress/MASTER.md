...
| 3 | Desktop Studio Skeleton | https://github.com/zhu1090093659/plotforge/milestone/11 | 4 | 1 | 5 |
...
- [ ] Phase 3: Desktop Studio Skeleton (1/5 tasks) — [milestone](https://github.com/zhu1090093659/plotforge/milestone/11)
...
**Active Task**: T3.2 Add Tauri command bridge (Issue #32)
**Blockers**: None
...
1. Implement #32: add the Tauri command bridge over stable core commands.
