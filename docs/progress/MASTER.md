...
| 2 | Story Craft and Provider Contracts | https://github.com/zhu1090093659/plotforge/milestone/10 | 2 | 3 | 5 |
...
- [ ] Phase 2: Story Craft and Provider Contracts (3/5 tasks) — [milestone](https://github.com/zhu1090093659/plotforge/milestone/10)
...
**Active Task**: T2.4 Add reference-library compliance scaffolding (Issue #29)
**Blockers**: None
...
1. Implement #29: add reference-library compliance scaffolding.
