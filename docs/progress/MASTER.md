...
| 3 | Desktop Studio Skeleton | https://github.com/zhu1090093659/plotforge/milestone/11 | 3 | 2 | 5 |
...
- [ ] Phase 3: Desktop Studio Skeleton (2/5 tasks) — [milestone](https://github.com/zhu1090093659/plotforge/milestone/11)
...
**Active Task**: T3.3 Build project dashboard and source-file editor shell (Issue #33)
**Blockers**: None
...
1. Implement #33: build the project dashboard and source-file editor shell.
