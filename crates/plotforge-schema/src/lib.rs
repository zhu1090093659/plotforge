...
pub const CONTRACT_SCHEMA_VERSION: u32 = 24;
...
pub struct ContractRootSchemas {
    ...
    pub turn_usage_summary: TurnUsageSummary,
    pub provider_cost_report: ProviderCostReport,
...
export interface TurnUsageSummary { total_input_tokens: number; total_output_tokens: number; total_spent_cost_units: number; }
...
export interface PiAgentRunResult { descriptor: PiAgentDescriptor; reproducibility: ReproducibilityMetadata; usage?: UsageInfo | null; trace_id?: string | null; evidence_summary: string; }
...
mod tests {
    ...
    fn contract_bundle_uses_current_version_envelope() {
        ...
        assert_eq!(CONTRACT_SCHEMA_VERSION, 24);
