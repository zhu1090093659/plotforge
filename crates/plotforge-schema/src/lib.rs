...
pub const CONTRACT_SCHEMA_VERSION: u32 = 19;
...
mod tests {
    ...
    fn contract_bundle_uses_current_version_envelope() {
        ...
        assert_eq!(CONTRACT_SCHEMA_VERSION, 19);
